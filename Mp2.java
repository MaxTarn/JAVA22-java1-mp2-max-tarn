...
class Mp2{
    ...
    static void writeOutAll(Product potato, Product lolipop, Product pasta, DiscountProduct discountMilk){
        System.out.print("1. ");
        potato.writeOut();
        System.out.print("2. ");
        lolipop.writeOut();
    ...
    public static void main(String[] args) {
        ...
        DiscountProduct discountMilk = new DiscountProduct("Milk", 20, 2, 25);
